...
public class ReadConfigurations
{
	public static void readConfigurations(String[]args) throws IOException 
	{
		...
		for (int k=0; k < args.length; k++)
		{
			...
			else if (args[k].equals("-T")) Data.T = Integer.parseInt(args[++k]);
			else if (args[k].equals("-T_prime")) Data.T_prime = Integer.parseInt(args[++k]);	
		}
        // ==========================================================
		...
		System.out.println("rho: " + Float.toString(Data.rho));  
		...
		System.out.println("T_prime: " + Integer.toString(Data.T_prime));
        // ==========================================================
		...
		try {
			...
			Data.bw.write("rho: " + Float.toString(Data.rho) + "\r\n");
			...
			Data.bw.write("T: " + Integer.toString(Data.T) + "\r\n");
			Data.bw.write("T_prime: " + Integer.toString(Data.T_prime) + "\r\n");
			// Data.bw.write("start_hybrid_averaging_iterations: " + Integer.toString(Data.start_hybrid_averaging_iterations) + "\r\n");
			// Data.bw.write("local_train_iterations: " + Integer.toString(Data.local_train_iterations) + "\r\n");
			// Data.bw.write("client_percent: " + Float.toString(Data.client_percent) + "\r\n");
			// Data.bw.write("noise_collectors_num: " + Integer.toString(Data.noise_collectors_num) + "\r\n");
			Data.bw.flush();
